...
/**
 * Invented Toronto environments seeded into the Public heatmap only, so it
 * reads as a populated city rather than the handful of captures that exist so
 * far. Personal and album scopes never include them — those are answerable
 * from a real library, and a fake pin there would be a lie about your own
 * captures.
 */
